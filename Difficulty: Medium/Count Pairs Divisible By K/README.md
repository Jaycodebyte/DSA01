...
<div bis_skin_checked="1"><span style="font-size: 18px;">1 ≤ |arr| ≤ 5*10<sup>4</sup></span></div>
<div bis_skin_checked="1"><span style="font-size: 18px;">1 ≤ arr[i] ≤ 10<sup>6</sup></span></div>
<div bis_skin_checked="1"><span style="font-size: 18px;">1 ≤ k ≤ 5*10<sup>4</sup></span></div></div><p><span style=font-size:18px><strong>Company Tags : </strong><br><code>PayPal</code>&nbsp;<br><p><span style=font-size:18px><strong>Topic Tags : </strong><br><code>Arrays</code>&nbsp;<code>Hash</code>&nbsp;<code>Data Structures</code>&nbsp;